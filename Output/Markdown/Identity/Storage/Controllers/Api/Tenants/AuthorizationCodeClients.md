...
|Name|Type|Required|Nullable|Description|
|---|---|---|---|---|
|AllowedCorsOrigins|List of strings|false|true|Gets or sets the values used by the default CORS policy service implementations to build a<br />CORS policy for JavaScript clients.|
